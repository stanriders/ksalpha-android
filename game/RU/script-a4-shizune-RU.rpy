label ru_S31:
    ...
    hh "Однако, после всего случившегося, кажется, %(name_shizune)s решила прекратить всякую деятельность, даже мыслительную."
    ...
    "Я впервые в комнате %(name_shizune)s. Обстановка довольно аскетичная и прагматичная, хотя то тут, то там я всё же замечаю присущие её индивидуальности черты."
...
label ru_S32:
    ...
    "Стоя перед дверью, я замираю. Мне немного страшно. Она может снова не посмотреть на меня, и, если это случится, я не знаю, смогу ли хоть что-то сделать. И, даже если она на меня посмотрит, я не уверен, что смогу выдержать её взгляд."
...
label ru_S33:
    ...
    play sound sfx_rustling
    $fixedwritten_note((name_sicchan) + (u", я сделаю всё, чтобы вы с ") + (name_hicchan) + (u"ом смогли быть вместе. Меньшее было бы полным эгоизмом. Счастье ") + (name_hicchan) + (u"а и %(name_sicchan)s важнее моего. Если мои друзья будут счастливы, я тоже буду."))
    ...
    yu "Э, вообще-то всё… непросто. Кто-то крадёт отсюда много книг, и всё бы ничего, пока они крали книги, которые у нас более чем в трёх экземплярах, однако…"
    ...
    yu "Я не уйду, пока не поймаю их."
    ...
    "Судя по выражению её лица, полагаю она знает, от каких именно."
    ...
    "Её голос настолько тих, что я едва слышу его. Всё это весьма неловко, весь этот разговор. Избегать упоминания имени Миши, словно это лишь подчеркнёт тот факт, что её больше нет. Не за этим я сюда пришёл."
...
label ru_S37:
    ...
    "Краснея, она начинает приближаться ко мне и берёт меня за руки. Без предупреждения она скручивает их у меня за спиной и её правая рука начинает подкрадывается к моему паху, по пути слегка ослабляя пряжку моего ремня."
    ...
    "Её большая грудь упираются в меня, другой рукой она до сих пор удерживает мои руки сзади, скручивая их в рогалик, всякий раз, когда я пытаюсь освободиться, и с каждой последующей попыткой я всё меньше сопротивляюсь."
...
label ru_S37h:
    ...
    "Чувствуя моё предвкушение, она медленно опускается на меня сверху, всё больше краснея по мере того, как я всё глубже погружается в её горячее и влажное влагалище."
    ...
    "Я едва не теряю сознание от удовольствия, когда влагалище %(name_shizune)s сжимается всё плотнее вокруг моего члена, волнообразно двигаясь, и с каждым толчком всё сильнее трётся о меня своей промежностью."
...
label ru_S38:
    ...
    hi "Я поступлю в институт и стану учителем. Физика даётся мне лучше всего. Во всяком случае, этот предмет наиболее мне интересен. Поэтому буду учить физике. По-видимому, чтобы стать учителем, нужно сдать не слишком сложный экзамен, главное – сдать его вовремя."
